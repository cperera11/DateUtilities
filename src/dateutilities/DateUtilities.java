...
/**
     * This date time utility class is to provide various date and time utility methods
...
public class DateUtilities {
    ...
    /**
     * Format current <code>Date</code> to the most common pattern - month, date, year
     *  @return the current formatted string date to the pattern month, date, year
     */
    ...
    /**
     * Increment a user input string <code>Date</code> in any user given number of days, weeks, months, 
     * or years by using the parse pattern yyyy-mm-dd. Other than the string date, 
     * at least a 0 is required for every integer arguments  
     *
     ...
     * @throws IllegalArgumentException if date or number of days, weeks, months, or years are null
     */   
   ...
   /**
     * Decrement a user input string <code>Date</code> in any user given number of days, weeks, months, 
     * or years by using the parse pattern yyyy-mm-dd. Other than the string date, 
     * at least a 0 is required for every integer arguments 
     *
     * @param date - a string representation of a date
     ...
     */   
     ...
     /**
     * Increment a user input string <code>Date</code> in any user given number of minutes or hours
     * by using the parse pattern yyyy-mm-dd. Other than the string date, 
     * at least a 0 is required for every integer arguments  
     *
     * @param date - a string representation of a date
     ...
     * @return the incremented string date in Local date type
     * @throws IllegalArgumentException if date or number of seconds, minutes or hours are null
     */   
   ...
   /**
     * Decrement a user input string <code>Date</code> in any user given number of minutes or hours
     * by using the parse pattern yyyy-mm-dd. Other than the string date, 
     * at least a 0 is required for every integer arguments  
     *
     * @param date - a string representation of a date
